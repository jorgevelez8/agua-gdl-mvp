...
export const bloque: ThemeDefinition = {
  ...
  motif: "hardShapes",
  // Sin photoOverlay a propósito: el scrim que el lima necesita para no
  // vibrar (probado en PNG a 0.85 de opacidad) anula la foto hasta volverla
  // irreconocible como escena, tanto con fuente oscura como clara — no
  // refuerza el mensaje, solo lo cumple a medias. Bloque ya es un lenguaje
  // visual completo (negro + lima + formas duras + glow) sin foto.
};
